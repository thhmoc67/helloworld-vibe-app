...
function StatColumn({ value, label, star }: { value: string; label: string; star?: boolean }) {
  return (
    <View style={styles.statCol}>
      ...
      <View style={styles.statLabelRow}>
        ...
        <Typography variant="text" size="xs" weight="medium" color={palette.gray[400]}>
          {label}
        </Typography>
      </View>
    </View>
...
export function HdpRatingCard({
  ...
  return (
    <LinearGradient
      colors={['rgba(255,255,255,0.92)', 'rgba(213,236,249,0.56)']}
      start={{ x: 0, y: 0 }}
      end={{ x: 1, y: 1 }}
      style={styles.card}>
      <View style={styles.top}>
        ...
        <Typography variant="text" size="lg" weight="medium" color={palette.gray[800]}>
      ...
      <View style={styles.statsRow}>
        ...
        <Image source={ImageAssets.hdpTrophy} style={styles.trophy} contentFit="contain" />
      </View>
    </LinearGradient>
  );
}
